...
This is a simple ER Diagram of the full table this data will be sent to in PostgreSQL. _While all columns are shown here the only ones relevant to this project_ are found in the diagram ⬆.
